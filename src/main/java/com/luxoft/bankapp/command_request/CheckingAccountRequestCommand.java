 ...
 */
public class CheckingAccountRequestCommand implements Command {
    ...
    public CheckingAccountRequestCommand(String message, ObjectInputStream objectInputStream, ObjectOutputStream objectOutputStream) {
    ...
    public void execute() throws ClientNotFoundException, NotEnoughtFundsException, ClientExistsException {
        activeAccountRequest = new ChangeActiveAccountRequest(AccountType.CHECKING_ACCOUNT);
